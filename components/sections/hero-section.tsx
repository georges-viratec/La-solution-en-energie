  ...
  return (
    <section className="relative overflow-hidden min-h-screen px-4 sm:px-6 lg:px-8 flex items-center py-20 sm:py-0">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="absolute top-4 left-4 sm:top-8 sm:left-6 lg:left-8 z-10">
          <Image
            src="/logo.png"
        ...
        <div className="text-center space-y-4 sm:space-y-6 max-w-5xl mx-auto pt-16 sm:pt-0">
          {/* Top badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full bg-accent/10 border border-accent/20">
          ...
          {/* Main headline */}
          <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-[1.1] tracking-tight px-2">
            Devenez courtier en{" "}
          ...
          {/* Subtitle */}
          <p className="text-sm sm:text-base lg:text-lg text-muted-foreground leading-relaxed max-w-4xl mx-auto px-2">
          ...
          {/* Stats cards */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 lg:gap-10 pt-2 sm:pt-4 max-w-4xl mx-auto">
